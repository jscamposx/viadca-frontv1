...
const ContactCTA = () => {
  return (
    <section 
      ...
      className="w-full bg-background py-24 md:py-40 px-6 md:px-12 border-t border-muted/20 transition-colors duration-300"
    >
        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full md:w-auto">
          ...
          >
            <span className="relative z-10 flex items-center">
              ...
              <ArrowRight aria-hidden="true" className="ml-2 w-5 h-5 group-hover:translate-x-1 transition-transform" />
            </span>
          </button>
